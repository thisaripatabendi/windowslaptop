        ...
        info = @Info(
                ...
                extensions = {
                        @Extension(properties = {
                                @ExtensionProperty(name = "name", value = "windowslaptop"),
                                @ExtensionProperty(name = "context", value = "/windowslaptop"),
                        })
                }
        ),
        tags = {
                @Tag(name = "windowslaptop", description = "")
        }
)
@Scopes(
        scopes = {
                @Scope(
                        name = "Enroll device",
                        description = "",
                        key = "perm:windowslaptop:enroll",
                        permissions = {"/device-mgt/devices/enroll/windowslaptop"}
                )
        }
)
...
public interface DeviceTypeService {
    ...
    @ApiOperation(
            ...
            extensions = {
                    @Extension(properties = {
                            @ExtensionProperty(name = SCOPE, value = "perm:windowslaptop:enroll")
                    })
            }
    )
