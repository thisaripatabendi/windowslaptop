...
package org.laptop.windowslaptop.plugin.constants;
...
public class DeviceTypeConstants {
    public final static String DEVICE_TYPE = "windowslaptop";
    public final static String DEVICE_PLUGIN_DEVICE_NAME = "DEVICE_NAME";
    public final static String DEVICE_PLUGIN_DEVICE_ID = "windowslaptop_DEVICE_ID";
...
//    public static final String SENSOR_TYPE3_EVENT_TABLE = "ORG_WSO2_IOT_DEVICES_windowscpuusage";
    ...
    public static final String DATA_SOURCE_NAME = "jdbc/windowslaptopDM_DB";
    ...
    public static final String SUBSCRIBED_TOPIC = "carbon.super/windowslaptop/+/windowsbatterylevel";
    ...
    public final static String SENSOR_TYPE1_STREAM_DEFINITION = "org.wso2.iot.devices.windowsbatterylevel";
    public final static String SENSOR_TYPE1_STREAM_DEFINITION_VERSION = "1.0.0";

    public final static String SENSOR_TYPE2_STREAM_DEFINITION = "org.wso2.iot.devices.windowsbatterystatus";
